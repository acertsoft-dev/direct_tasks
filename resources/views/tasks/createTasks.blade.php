                    ...
                    <div class="div-form">
                        ...
                        <div class="inputs-primary">
                            ...
                            <div class="div-inputs">
                                ...
                                @if(isset($task))
                                    <input type="datetime-local" name="date_limit" id="date_limit" required value="{{$task->date_limit}}" max="9999-12-31 23:59:59">
                                @else
                                    <input type="datetime-local" name="date_limit" id="date_limit" onchange="trasValor(this.value)" required max="9999-12-31 23:59:59">
                                @endif
                            </div>
                        </div>
                    </div>
